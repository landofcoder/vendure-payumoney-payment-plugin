import { PayumoneyGateway, Environment, Transaction } from 'payumoney';

import { PaymentMethodArgsHash } from '../types';

export function getGateway(args: PaymentMethodArgsHash): PayumoneyGateway {
    return new PayumoneyGateway({
